          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-20">
            ...
            <div className="lg:col-span-7 flex flex-col gap-12">
              <section>
                ...
                {/* Notice — matches code copy.html: bg-primary/5 border-primary/20 text-primary/90 */}
              ...
              <div className="pt-4">
                <button
                  type="button"
                  className="w-full md:w-auto px-12 md:px-16 py-5 bg-gold text-obsidian font-medium font-serif text-lg md:text-xl hover:bg-gold/90 transition-all rounded shadow-lg shadow-gold/10"
                >
            ...
            {/* Right: Order Summary — border-white/10 bg-white/[0.02] */}
