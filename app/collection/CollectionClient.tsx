      ...
      <main className="relative z-20 px-6 lg:px-40 pt-40 pb-32 max-w-[1400px]">
        ...
        <div className="flex flex-col gap-12 mb-20">
          <div className="flex flex-col gap-4">
            <h1 className="font-serif text-5xl md:text-6xl text-parchment leading-tight text-glow">
            ...
            <div key={product.id} className="group cursor-pointer">
              ...
              <div className="flex flex-col gap-2">
                <Link href={`/product/${product.slug}`}>
                  <h3 className="font-serif text-3xl text-parchment group-hover:text-primary transition-colors duration-300">
                    {product.name}
                  </h3>
                </Link>
        ...
        {filteredProducts.length === 0 && (
          <div className="py-40 text-center animate-in fade-in zoom-in-95 duration-1000">
            <p className="text-parchment/20 font-serif italic text-3xl lg:text-5xl">
