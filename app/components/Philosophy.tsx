  ...
  return (
    <section className="py-24 bg-background-light dark:bg-background-dark">
      <div className="max-w-[800px] mx-auto px-6">
        ...
        <p className="text-[#112116] dark:text-white/90 text-2xl md:text-3xl font-light leading-relaxed text-center italic">
          {quote}
        </p>
        <div className="flex justify-center mt-12">
          <div className="size-1 bg-primary rounded-full mx-2" />
          <div className="size-1 bg-primary/40 rounded-full mx-2" />
