        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-20">
          ...
          <div className="lg:col-span-7 flex flex-col gap-12">
            ...
            <div className="pt-4">
              <button
                type="button"
                className="w-full md:w-auto px-12 md:px-16 py-5 bg-primary text-obsidian font-medium font-serif text-lg md:text-xl hover:bg-primary/90 transition-all rounded-lg shadow-lg shadow-primary/20"
              >
            ...
            <div className="sticky top-28 border border-travertine/30 p-8 md:p-10 rounded-lg bg-evergreen/5">
              ...
              <div className="flex flex-col gap-8">
                {summaryItems.map((item) => (
                  <div
                    key={item.name}
                    className="flex items-center gap-6 pb-8 border-b border-travertine/20 last:border-0 last:pb-0"
                  >
                    <div
