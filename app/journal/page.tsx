      ...
      <main className="relative flex-1 min-h-screen pt-28 pb-20">
        <div className="max-w-[800px] mx-auto px-6 py-12 md:py-24">
          ...
          <div className="flex flex-col gap-6 mb-20 text-center">
            <h1 className="text-white text-5xl md:text-7xl font-extralight italic tracking-tight leading-[1.1] font-[family-name:var(--font-serif)]">
              The Journal
            </h1>
            <p className="text-white/60 text-lg font-light max-w-xl mx-auto italic">
          ...
          {/* Filter Tabs */}
          <div className="mb-16">
            <div className="flex border-b border-white/10 justify-center gap-12 flex-wrap">
              {filterTabs.map((tab) => (
                <button
                  key={tab.label}
                  type="button"
                  className={`flex flex-col items-center justify-center border-b-2 pb-4 ${
                    tab.active
                      ...
                      : "border-transparent text-white/50 hover:text-primary transition-colors"
                  }`}
                >
              ...
              <article key={entry.title} className="group cursor-pointer">
                <div className="flex flex-col gap-8">
                  ...
                  <div className="flex flex-col gap-4">
                    <span className="text-white/50 text-xs font-light tracking-[0.4em] uppercase">
                      {entry.category}
                    </span>
                    <h2 className="text-white text-3xl md:text-4xl font-light italic leading-tight font-[family-name:var(--font-serif)]">
                      {entry.title}
                    </h2>
          ...
          <div className="mt-32 border-t border-white/10 pt-16 text-center">
            ...
            <div className="mt-24 mb-12 text-white/40 text-[10px] tracking-[0.5em] uppercase">
